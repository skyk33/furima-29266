...
ActiveRecord::Schema.define(version: 2020_09_14_021038) do
  ...
  create_table "delivery_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_order_id"], name: "index_delivery_addresses_on_purchase_order_id"
  end
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "delivery_charge_type_id", null: false
    t.integer "prefecture_id", null: false
  ...
  add_foreign_key "delivery_addresses", "purchase_orders"
